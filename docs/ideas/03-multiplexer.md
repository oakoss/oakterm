...
- Image protocols don't work in tmux → both Kitty + Sixel work through multiplexer (image protocol forwarding is core per [ADR 0004](../adrs/0004-kitty-graphics-in-core.md))
